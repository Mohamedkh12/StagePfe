...
const AbonnementParent = ({ navigation }) => {
    ...
    const images = useMemo(() => ({
        option1: require('../assets/images/child-Mobile-inscription3.png'),
        option2: require('../assets/images/2children-Mobile-inscription3.png'),
        option3: require('../assets/images/3children-Mobile-inscription3.png'),
    }), []);
